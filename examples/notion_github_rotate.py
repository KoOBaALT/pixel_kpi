...
def main():
    ...
    parser.add_argument('--switch_interval', type=int, default=300, help='View switch interval in seconds (default: 300)')
    ...
    rotating_view = RotatingView(
        display=display,
        views=[notion_sprint_view, github_stars_view],
        refresh_rate=args.refresh_rate,
...
#python examples/notion_github_rotate.py \
#  --display_type terminal \
#  --ip_address "192.168.178.153" \
#  --notion_api_key "your_notion_api_key" \
#  --notion_database_id "your_database_id" \
#  --github_api_key "your_github_api_key" \
#  --github_repo "pi_optimal/pi_optimal" \
#  --refresh_rate 900 \
#  --switch_interval 300